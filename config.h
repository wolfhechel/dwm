...
static const int barline            = 2;
static const char *fonts[]          = {
    "Noto Sans Mono:size=13"
};
static const char col_dark[] = "#222222";
static const char col_light[] = "#393939";
static const char col_text[] = "#ffffff";

static const char *colors[][3]      = {
	/*               fg         bg          border   */
	[SchemeNorm] = { col_text, col_dark,  col_dark  },
	[SchemeSel]  = { col_text, col_light, col_light },
};
...
#define ROFI_MODE(mode) (const char*[]){ "rofi", "-show", mode, NULL }

static const char *dmenucmd[] = ROFI_MODE("drun");
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      spawn,          {.v = ROFI_MODE("sys") } },
    { MODKEY|ControlMask,           XK_p,      spawn,          {.v = ROFI_MODE("file-browser") } },
